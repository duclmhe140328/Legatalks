        ...
        {showRightRail && (
          <aside className="fb-right-rail">
            ...
            <section className="fb-right-promo">
              ...
              <div><b>Tạo phòng họp nhanh</b><p>Mời bạn bè tham gia ngay trong hệ sinh thái Legatalk.</p><button type="button" onClick={() => navigate('/meetings')}>Mở Meeting Hub</button></div>
            </section>
          </aside>
        )}
      </div>
