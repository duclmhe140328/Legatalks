...
export default function ContactsPage() {
  ...
  return <div className="contacts-page">
    ...
    <aside className="contacts-tools">
      ...
      <div className="card tool-card"><h3><QrCode /> Thêm bằng QR</h3><p>Dán nội dung dạng <code>nexora://user/...</code>.</p><input value={qrValue} onChange={(e) => setQrValue(e.target.value)} placeholder="nexora://user/..." /><button className="secondary-btn" onClick={scanQr}>Kiểm tra mã</button></div>
    </aside>
  </div>;
}
