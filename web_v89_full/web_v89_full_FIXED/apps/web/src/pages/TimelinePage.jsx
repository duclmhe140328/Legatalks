  ...
  return <div className="share-overlay" onMouseDown={(event) => { if (event.target === event.currentTarget) onClose(); }}>
    <div className="share-sheet">
      ...
      {mode === 'actions' && <div className="share-options">
        ...
        <button onClick={() => setMode('message')}><span className="share-option-icon message"><Send /></span><div><b>Gửi vào tin nhắn</b><small>Chọn một cuộc trò chuyện Nexora</small></div></button>
