...
export default function MeetingsPage() {
  ...
  return <div className="meetings-page">
    <section className="meetings-hero card">
      <div><span className="eyebrow"><Video size={15} /> Họp online</span><h2>Họp online bằng Jitsi Meet SDK</h2><p>Tạo phòng họp Jitsi, đặt lịch trước, web dùng Jitsi IFrame API SDK và mobile dùng Jitsi native SDK. Web/app cùng vào đúng một roomName.</p></div>
